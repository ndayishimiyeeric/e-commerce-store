...
export async function PATCH(
  ...
  try {
    ...
    if (!name || !billboardId) {
      return new Response(
        "Bad Request Both name and billboard id are required",
        { status: 400 }
      );
    }
    ...
    return new Response(
      "Internal server error, can not update category at this time",
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    if (!params.categoryId) {
      return new Response("Bad Request category id is required", {
        status: 400,
      });
    }
    ...
    return new Response(
      "Internal server error, can not delete category at this time",
      { status: 500 }
    );
  }
}
...
export async function GET(
  ...
  try {
    ...
    return new Response(
      "Internal server error, can not get category at this time",
      { status: 500 }
    );
  }
}
