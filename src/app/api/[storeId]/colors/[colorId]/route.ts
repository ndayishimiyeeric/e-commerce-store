...
export async function PATCH(
  ...
  try {
    ...
    return new Response(
      "Internal server error, can not update color at this time",
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return new Response(
      "Internal server error, can not delete color at this time",
      { status: 500 }
    );
  }
}
...
export async function GET(
  ...
  try {
    ...
    return new Response(
      "Internal server error, can not get color at this time",
      { status: 500 }
    );
  }
}
