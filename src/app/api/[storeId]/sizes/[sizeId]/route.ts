...
export async function PATCH(
  ...
  try {
    ...
    return new Response(
      "Internal server error, can not update size at this time",
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return new Response(
      "Internal server error, can not delete size at this time",
      { status: 500 }
    );
  }
}
...
export async function GET(
  ...
  try {
    ...
    return new Response(
      "Internal server error, can not get size at this time",
      { status: 500 }
    );
  }
}
