...
import {BillboardFormSchema, BillboardFormSchemaType} from "@/lib/validators/billboard-form";
...
const BillboardForm = ({billboard}: BillboardFormProps) => {
    ...
    const description = billboard ? 'Edit your billboard' : 'Create a new billboard';
    ...
    const {mutate: CreateUpdateBillboard, isLoading: CreateUpdateBillboardIsLoading} = useMutation({
    ...
    const {mutate: DeleteBillboard, isLoading: DeleteBIllboardLoading} = useMutation({
        mutationFn: async () => {
    ...
    return (
        <>
            <AlertModal isOpen={open} onClose={() => setOpen(false)} onConfirm={DeleteBillboard} loading={CreateUpdateBillboardIsLoading || DeleteBIllboardLoading}/>
            <div className="flex items-center justify-between">
                ...
                {billboard && (<Button
                    ...
                    isLoading={DeleteBIllboardLoading}
                    size="sm"
                    onClick={() => {
                        setOpen(true)
                    }}
            ...
            <Form {...form}>
                ...
                >
                        ...
                        <FormField
                            render={({field}) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={CreateUpdateBillboardIsLoading} placeholder="Billboard label" {...field}/>
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
                            )}
                    ...
                    <Button
                        ...
                        className="ml-auto"
                        disabled={CreateUpdateBillboardIsLoading || DeleteBIllboardLoading}
                        isLoading={CreateUpdateBillboardIsLoading}
                    >{action}</Button>
                </form>
            </Form>
