...
import {ColorFormSchema, ColorFormSchemaType} from "@/lib/validators/color-form";
...
const ColorForm = ({color}: ColorFormProps) => {
    ...
    const {mutate: Delete, isLoading: DeleteLoading} = useMutation({
        ...
        onError: (err) => {
            ...
            return toast.error('Make sure to delete all products using this color first.');
        },
        onSuccess: () => {
            router.push(`/${params.storeId}/colors`);
            router.refresh();
                        ...
                        <FormField
                            render={({field}) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={CreateUpdateLoading} placeholder="Color name" {...field}/>
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
                            )}
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <div className="flex items-center gap-x-4">
                                            <Input disabled={CreateUpdateLoading} placeholder="Color Value" {...field}/>
