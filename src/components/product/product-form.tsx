...
import {ProductFormSchema, ProductFormSchemaType} from "@/lib/validators/product-form";
                        ...
                        <FormField
                            render={({field}) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={CreateUpdateLoading} placeholder="Product name" {...field}/>
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
                            )}
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <div className="flex items-center gap-x-4">
                                            <Input type="number" disabled={CreateUpdateLoading} placeholder="Product price" {...field}/>
                                        </div>
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
                        ...
                        <FormField
                            render={({field}) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <div className="flex items-center gap-x-4">
                                            <Input type="number" disabled={CreateUpdateLoading} placeholder="Quantity in stock" {...field}/>
                                        </div>
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
