...
const SizeForm = ({size}: SizeFormProps) => {
    ...
    const {mutate: Delete, isLoading: DeleteLoading} = useMutation({
        ...
        onError: (err) => {
            ...
            return toast.error('Make sure to delete all products using this size first.');
        },
        onSuccess: () => {
            router.push(`/${params.storeId}/sizes`);
            router.refresh();
                        ...
                        <FormField
                            render={({field}) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={CreateUpdateLoading} placeholder="Size Name" {...field}/>
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
                            )}
                        ...
                        <FormField
                            render={({field}) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={CreateUpdateLoading} placeholder="Size Value" {...field}/>
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
                            )}
